  ...
  return (
    ...
    <Title title={`${details.jobtitle}-${details.companyname}`} />
      ...
      <div className=" px-10 py-2">
        ...
        <h1 className="text-[1.5rem] text-left font-poppins font-[700] mt-4 sm:mx-[15rem]">Job Description:</h1>
        <div className=" sm:mx-[15rem] text-start" dangerouslySetInnerHTML={{ __html: jobdescription }}/>
